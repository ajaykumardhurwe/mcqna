...
// import { FaPhoneAlt, FaUser, FaPen, FaCheckCircle } from "react-icons/fa";

// // Google Sheets API & WhatsApp API integration (use appropriate services in real app)
...
//     try {
//       // Placeholder for Google Sheets API integration (make an API call to save data to Google Sheets)
//       const response = await fetch("/api/save-to-google-sheets", {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//         },
//         body: JSON.stringify({ name, mobile, description }),
//       });

//       if (response.ok) {
//         // Notify via WhatsApp (Placeholder)
//         await fetch("/api/send-whatsapp-notification", {
//           method: "POST",
//           headers: {
//             "Content-Type": "application/json",
//           },
//           body: JSON.stringify({ mobile, message: "Your eForm has been submitted successfully!" }),
//         });
...
//             placeholder="Which form would you like to fill? (e.g., Job, CSC, etc.)"
...
//     try {
//       const response = await fetch("https://script.google.com/macros/s/AKfycbyvWk8v1jIdXg4asHxQ-l4S3XOKbykPlkwVr4Rfk8t8YNIwHbzzO9RdPWnaFq1_aIkb-Q/exec", {
//         method: "POST",
//         headers: {
...
//     // Regex for validating mobile number with country code
...
//   const whatsappLink = `https://wa.me/${mobile.replace(/\D/g, "")}?text=Hi%20I%20am%20interested%20in%20your%20services!`;
...
//   const [mobile, setMobile] = useState("");
//   const [description, setDescription] = useState("");
//   const [dateTime, setDateTime] = useState(""); // State to store selected date and time
//   const [loading, setLoading] = useState(false);
//   const [success, setSuccess] = useState(false);
//   const [mobileError, setMobileError] = useState("");
...
//           mobile,
//           description,
//           dateTime, // Send the selected date and time to the backend
//         }),
//       });
...
//   const whatsappLink = `https://wa.me/+9301084259?text=Hi%20I%20am%20interested%20in%20your%20services%20and%20would%20like%20to%20schedule%20a%20meeting%20on%20${dateTime}`;
...
//   const whatsappLink = `https://wa.me/+919301084259?text=Hi%20I%20am%20interested%20in%20your%20services%20and%20would%20like%20to%20schedule%20a%20meeting%20on%20${date}T${time}`;
